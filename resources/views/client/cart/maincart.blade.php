                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="quantity">
                                <div class="quantity-input">
                                    <input type="number" name="product-quatity" class="cart_quantity"
                                        value="{{ $cart['quantity'] }}" data-max="120" pattern="[0-9]*">
                            ...
                            <div class="delete">
                                <a href="{{ url('client/delete-cart/' . $cart['id']) }}" class="btn btn-delete" title="">
                                    <span>Delete from your cart</span>
                                    <i class="fa fa-times-circle" aria-hidden="fasle"></i>
                                </a>
                            </div>
                        </li>
                    </ul>
