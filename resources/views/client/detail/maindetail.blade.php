                ...
                <div class="wrap-product-detail">
                    <form>
                        ...
                        <div class="detail-media">
                            <img src="{{ asset('assets1/upload/product/' . $product->image) }}"
                            ...
                            <div class="quantity">
                                ...
                                <div class="quantity-input">
                                    <input type="text" name="product-quatity"
                                        class="cart_product_quantity_{{ $product->id }}" value="1"
                                        data-max="{{ $product->amount }}" pattern="[0-9]*">
                                    <a class="btn btn-reduce" href="#"></a>
                                    <a class="btn btn-increase" href="#"></a>
                                </div>
                            </div>
                            <div class="wrap-butons">
                                <input type="hidden" class="cart_product_id_{{ $product->id }}"
                                    value="{{ $product->id }}">
                                <input type="hidden" class="cart_product_name_{{ $product->id }}"
                                    value="{{ $product->name }}">
                                <input type="hidden" class="cart_product_image_{{ $product->id }}"
                                    value="{{ $product->image }}">
                                <input type="hidden" class="cart_product_price_{{ $product->id }}"
                                    value="{{ $product->price }}">
                                <button type="button" class="btn add-to-cart" data-id_product="{{ $product->id }}"
                            ...
                            <li class="service">
                                <a class="link-to-service" href="#">
                                    ...
                                    <div class="right-content">
                                        ...
                                        <span class="subtitle">On Oder Over 500.000 VND</span>
