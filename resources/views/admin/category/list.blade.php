                ...
                <thead class="thead-light">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{url('amin/category/edit-category/'.$item->id)}}" class="btn btn-primary btn-sm">Edit</a>
                        <a href="{{url('amin/category/delete-category/'.$item->id)}}" class="btn btn-danger btn-sm">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
